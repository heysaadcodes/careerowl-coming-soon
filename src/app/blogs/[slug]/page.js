...
const BlogDetailPage = () => {
  ...
  const siteUrl = "https://thecareerowl.ca";
  const fullUrl = `${siteUrl}/blog/${blog.slug}`;
    ...
    const structuredData = [
      {
        ...
        "logo": "https://thecareerowl.ca/new-owl-logo.svg",
        "foundingDate": "1999",
        "address": {
          "@type": "PostalAddress",
          "addressCountry": "CA"
      ...
      },
      {
        ...
        "@type": "PressRelease",
        "headline": blog.title,
        "alternativeHeadline": blog.description || blog.content[0]?.text?.substring(0, 100) + '...',
        ...
        "articleBody": blog.content.map(section => section.text).join(' ').substring(0, 500) + '...'
      }
    ];
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content={blog.description || blog.content[0]?.text?.substring(0, 160) + '...'} />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={fullUrl} />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content={blog.title} />
        <meta property="og:description" content={blog.description || blog.content[0]?.text?.substring(0, 160) + '...'} />
        ...
        <meta property="article:modified_time" content={new Date(blog.date).toISOString()} />
        ...
        <meta name="twitter:description" content={blog.description || blog.content[0]?.text?.substring(0, 160) + '...'} />
        <meta name="twitter:image" content={blog.image} />
        <meta name="twitter:site" content="@careerowl" />

        {/* Additional Meta Tags */}
        <meta name="author" content={blog.author} />
        <meta name="keywords" content={`career, ${blog.category}, ${blog.tags?.join(', ') || ''}, Canadian jobs`} />
